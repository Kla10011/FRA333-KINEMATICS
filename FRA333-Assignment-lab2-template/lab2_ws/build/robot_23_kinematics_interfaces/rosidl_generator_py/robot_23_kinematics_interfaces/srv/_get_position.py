...
class GetPosition_Request(metaclass=Metaclass_GetPosition_Request):
    ...
    def __init__(self, **kwargs):
        ...
        from sensor_msgs.msg import JointState
        self.joints = kwargs.get('joints', JointState())
    ...
    def joints(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'joints' field must be a sub message of type 'JointState'"
        self._joints = value
...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_23_kinematics_interfaces.srv.GetPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_23_kinematics_interfaces.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from robot_23_kinematics_interfaces.srv._get_position import GetPosition_Request as Request
    from robot_23_kinematics_interfaces.srv._get_position import GetPosition_Response as Response
