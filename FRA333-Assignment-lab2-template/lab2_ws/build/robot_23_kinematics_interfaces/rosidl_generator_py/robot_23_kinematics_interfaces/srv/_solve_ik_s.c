...
bool robot_23_kinematics_interfaces__srv__solve_ik__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_23_kinematics_interfaces.srv._solve_ik.SolveIK_Request", full_classname_dest, 60) == 0);
  }
  robot_23_kinematics_interfaces__srv__SolveIK_Request * ros_message = _ros_message;
  {  // point
...
PyObject * robot_23_kinematics_interfaces__srv__solve_ik__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_23_kinematics_interfaces.srv._solve_ik");
...
ROSIDL_GENERATOR_C_EXPORT
bool robot_23_kinematics_interfaces__srv__solve_ik__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_23_kinematics_interfaces.srv._solve_ik.SolveIK_Response", full_classname_dest, 61) == 0);
  }
  robot_23_kinematics_interfaces__srv__SolveIK_Response * ros_message = _ros_message;
  {  // q
