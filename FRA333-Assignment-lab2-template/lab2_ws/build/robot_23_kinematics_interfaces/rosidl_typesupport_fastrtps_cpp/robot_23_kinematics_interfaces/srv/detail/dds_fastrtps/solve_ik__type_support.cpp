...
#include "robot_23_kinematics_interfaces/srv/detail/solve_ik__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const robot_23_kinematics_interfaces::srv::SolveIK_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_23_kinematics_interfaces::srv::SolveIK_Request *>(
    untyped_ros_message);
...
{
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const robot_23_kinematics_interfaces::srv::SolveIK_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_23_kinematics_interfaces::srv::SolveIK_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK_Response__handle;
}
...
{
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK__handle;
}
