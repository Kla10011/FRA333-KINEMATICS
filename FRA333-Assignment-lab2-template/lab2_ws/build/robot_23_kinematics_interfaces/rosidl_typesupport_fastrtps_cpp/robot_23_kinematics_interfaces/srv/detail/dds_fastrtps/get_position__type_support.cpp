...
#include "robot_23_kinematics_interfaces/srv/detail/get_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_23_kinematics_interfaces::srv::GetPosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_23_kinematics_interfaces::srv::GetPosition_Request & ros_message)
{
  // Member: joints
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ...
    ros_message.joints, current_alignment);
...
{
  auto typed_message =
    static_cast<const robot_23_kinematics_interfaces::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_23_kinematics_interfaces::srv::GetPosition_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_robot_23_kinematics_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<robot_23_kinematics_interfaces::srv::GetPosition_Request>()
{
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_23_kinematics_interfaces, srv, GetPosition_Request)() {
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_23_kinematics_interfaces
cdr_serialize(
  const robot_23_kinematics_interfaces::srv::GetPosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: position
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_23_kinematics_interfaces::srv::GetPosition_Response & ros_message)
{
  // Member: position
...
{
  auto typed_message =
    static_cast<const robot_23_kinematics_interfaces::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_23_kinematics_interfaces::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_23_kinematics_interfaces, srv, GetPosition_Response)() {
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
{
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_23_kinematics_interfaces, srv, GetPosition)() {
  return &robot_23_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
