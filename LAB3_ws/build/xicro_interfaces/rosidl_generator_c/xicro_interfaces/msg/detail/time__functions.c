...
{
  xicro_interfaces__msg__Time * msg = (xicro_interfaces__msg__Time *)malloc(sizeof(xicro_interfaces__msg__Time));
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__msg__Time__Sequence__init(xicro_interfaces__msg__Time__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__msg__Time *)calloc(size, sizeof(xicro_interfaces__msg__Time));
    if (!data) {
      return false;
    }
...
{
  xicro_interfaces__msg__Time__Sequence * array = (xicro_interfaces__msg__Time__Sequence *)malloc(sizeof(xicro_interfaces__msg__Time__Sequence));
  if (!array) {
    return NULL;
  }
