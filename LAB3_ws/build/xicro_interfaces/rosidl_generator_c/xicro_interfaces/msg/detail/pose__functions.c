...
{
  xicro_interfaces__msg__Pose * msg = (xicro_interfaces__msg__Pose *)malloc(sizeof(xicro_interfaces__msg__Pose));
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__msg__Pose__Sequence__init(xicro_interfaces__msg__Pose__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__msg__Pose *)calloc(size, sizeof(xicro_interfaces__msg__Pose));
    if (!data) {
      return false;
    }
...
{
  xicro_interfaces__msg__Pose__Sequence * array = (xicro_interfaces__msg__Pose__Sequence *)malloc(sizeof(xicro_interfaces__msg__Pose__Sequence));
  if (!array) {
    return NULL;
  }
