...
#include "romeona_kinematics_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _SolveIK_Request_type_support_symbol_names_t _SolveIK_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, romeona_kinematics_interfaces, srv, SolveIK_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, romeona_kinematics_interfaces, srv, SolveIK_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_romeona_kinematics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, romeona_kinematics_interfaces, srv, SolveIK_Request)() {
  return &::romeona_kinematics_interfaces::srv::rosidl_typesupport_c::SolveIK_Request_message_type_support_handle;
}
...
static const _SolveIK_Response_type_support_symbol_names_t _SolveIK_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, romeona_kinematics_interfaces, srv, SolveIK_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, romeona_kinematics_interfaces, srv, SolveIK_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_romeona_kinematics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, romeona_kinematics_interfaces, srv, SolveIK_Response)() {
  return &::romeona_kinematics_interfaces::srv::rosidl_typesupport_c::SolveIK_Response_message_type_support_handle;
}
...
static const _SolveIK_type_support_symbol_names_t _SolveIK_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, romeona_kinematics_interfaces, srv, SolveIK)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, romeona_kinematics_interfaces, srv, SolveIK)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, romeona_kinematics_interfaces, srv, SolveIK)() {
  return &::romeona_kinematics_interfaces::srv::rosidl_typesupport_c::SolveIK_service_type_support_handle;
}
