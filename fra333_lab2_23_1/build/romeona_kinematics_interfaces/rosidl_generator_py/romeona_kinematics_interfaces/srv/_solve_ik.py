...
class Metaclass_SolveIK(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'romeona_kinematics_interfaces.srv.SolveIK')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from romeona_kinematics_interfaces.srv import _solve_ik
...
class SolveIK(metaclass=Metaclass_SolveIK):
    from romeona_kinematics_interfaces.srv._solve_ik import SolveIK_Request as Request
    from romeona_kinematics_interfaces.srv._solve_ik import SolveIK_Response as Response
