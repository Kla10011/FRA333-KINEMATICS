...
#include "romeona_kinematics_interfaces/srv/detail/solve_ik__rosidl_typesupport_fastrtps_c.h"
...
using _SolveIK_Request__ros_msg_type = romeona_kinematics_interfaces__srv__SolveIK_Request;
...
size_t get_serialized_size_romeona_kinematics_interfaces__srv__SolveIK_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SolveIK_Request__ros_msg_type * ros_message = static_cast<const _SolveIK_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SolveIK_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_romeona_kinematics_interfaces__srv__SolveIK_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_romeona_kinematics_interfaces
size_t max_serialized_size_romeona_kinematics_interfaces__srv__SolveIK_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_romeona_kinematics_interfaces__srv__SolveIK_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, romeona_kinematics_interfaces, srv, SolveIK_Request)() {
...
#include "std_msgs/msg/detail/bool__functions.h"  // flag
...
using _SolveIK_Response__ros_msg_type = romeona_kinematics_interfaces__srv__SolveIK_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_romeona_kinematics_interfaces
size_t get_serialized_size_romeona_kinematics_interfaces__srv__SolveIK_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SolveIK_Response__ros_msg_type * ros_message = static_cast<const _SolveIK_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_romeona_kinematics_interfaces__srv__SolveIK_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_romeona_kinematics_interfaces
size_t max_serialized_size_romeona_kinematics_interfaces__srv__SolveIK_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_romeona_kinematics_interfaces__srv__SolveIK_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, romeona_kinematics_interfaces, srv, SolveIK_Response)() {
...
// already included above
// #include "romeona_kinematics_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "romeona_kinematics_interfaces/srv/solve_ik.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, romeona_kinematics_interfaces, srv, SolveIK)() {
