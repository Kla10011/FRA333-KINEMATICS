...
class SetGoal_Request(metaclass=Metaclass_SetGoal_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.g = array.array('f', kwargs.get('g', []))
    ...
    def g(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'g' array.array() must have the type code of 'f'"
            self._g = value
            return
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'g' field must be a set or sequence and each value of type 'float'"
        self._g = array.array('f', value)
...
class Metaclass_SetGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robot_interfaces.srv import _set_goal
...
class SetGoal(metaclass=Metaclass_SetGoal):
    from robot_interfaces.srv._set_goal import SetGoal_Request as Request
    from robot_interfaces.srv._set_goal import SetGoal_Response as Response
